                                ...
                                <div class="col-lg-12 col-xxl-4">
                                    ...
                                    <div class="card-header align-items-center border-0 mt-4">
                                        <h3 class="card-title align-items-start flex-column">
                                            <span class="font-weight-bolder text-dark">Data Mahasiswa Yang Sedang Menempuh Tugas Akhir</span>
                                        </h3>
                                    </div>
                                    <!--begin::Card-->
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php foreach ($mahasiswa as $mhs) : ?>
                                                            <tr>
                                                                ...
                                                                <td><?= $mhs->pildos1; ?></td>
                                                                <td><?= $mhs->pildos2; ?></td>
                                                                <td><?php if ($mhs->step == 1) {
                                                                        echo "Step 1 : Pengajuan Judul";
                                                                    } else if ($mhs->step == 2) {
                                                                        echo "Bimbingan Proposal";
                                                                    } else if ($mhs->step == 3) {
                                                                        echo "Ujian Proposal";
                                                                    } else if ($mhs->step == 4) {
                                                                        echo "Revisi Proposal";
                                                                    } else if ($mhs->step == 5) {
                                                                        echo "Step 5 : Mengerjakan Tugas Akhir";
                                                                    } else if ($mhs->step == 6) {
                                                                        echo "Bimbingan Tugas Akhir";
                                                                    } else if ($mhs->step == 7) {
                                                                        echo "Sidang Tugas Akhir";
                                                                    } else if ($mhs->step == 8) {
                                                                        echo "Revisi Tugas Akhir";
                                                                    } else {
                                                                        echo "Finish";
                                                                    }; ?></td>
                                                            </tr>
