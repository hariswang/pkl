...
<head>
    <base href="../../">
    <meta charset="utf-8" />
    <title>Koordinator | MoniTA</title>
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                        ...
                        <ul class="menu-nav">
                            <li class="menu-item" aria-haspopup="true">
                                <a href="<?= base_url('koordinator/index'); ?>" class="menu-link">
                                    <i class="menu-icon flaticon-home"></i>
                                    <span class="menu-text">Pengajuan Judul</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                                <a href="<?= base_url('koordinator/index_dosen'); ?>" class="menu-link">
                                    <i class="menu-icon flaticon-tabs"></i>
                                    <span class="menu-text">Daftar Dosen</span>
                                </a>
                            </li>
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    ...
                                    <span class="menu-text">Pengaturan Jadwal</span>
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            <a href="<?= base_url('koordinator/ujian_proposal'); ?>" class="menu-link">
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            <a href="<?= base_url('koordinator/ujian_ta'); ?>" class="menu-link">
                                                <i class="menu-bullet menu-bullet-line">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">Seminar dan Sidang TA</span>
                                                <i class="menu-arrow"></i>
                                            </a>
                                        </li>
                                    </ul>
