            ...
            <section class="content">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Menu Absensi Berita Acara</h3>
                </div>
                <div class="card-body">
                      ...
                      <div class="card card-custom gutter-b">
                        <div class="card-header flex-wrap py-3">
                          <div class="card-title">
                            <h3 class="card-label">Daftar Mahasiswa
                          </div>
                            ...
                            <?php $i = 1; ?>
                                        <?php foreach ($mahasiswa as $mhs) : ?>
                                            <tr>
                                                ...
                                                <td><?= $mhs->nim; ?></td>
                                                <td><?= $mhs->nama; ?></td>
                                                <td><?= $mhs->judul_berita; ?></td>
                                                <td><?= $mhs->berkas; ?></td>
                                                <td>
                                                    <a href="<?php echo site_url(); ?>mahasiswa/cek_absensi/<?= $mhs->nama; ?>" target="_blank" class=" btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Cek</a>
                                                </td>
                                            </tr>
                                            <?php $i++; ?>
                                        <?php endforeach; ?>
