            ...
            <section class="content">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Pengajuan Judul dan Pilih Dosen Pembimbing</h3>
                </div>
                <div class="card-body">
                  <!--begin::Form-->
                  <form class="form">
                      ...
                      <div class="form-group">
                        ...
                        <select class="custom-select form-control" name="pildos1" id="pildos1">
                          ...
                          <?php foreach ($dosen as $dsn) : ?>
                            <option value="<?php echo $dsn->id; ?>"><?= $dsn->nama; ?></option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                      <div class="form-group">
                        ...
                        <select class="custom-select form-control" name="pildos2" id="pildos2">
                          <option value="">Pilih Dosen</option>
                          <?php foreach ($dosen as $dsn) : ?>
                            <option value="1"><?= $dsn->nama; ?></option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                      <div class="form-group">
                    ...
                    <div class="card-footer">
                      ...
                      <button button="submit" type="reset" class="btn btn-secondary">Cancel</button>
                    </div>
                  </form>
                  <!--end::Form-->
                </div>
