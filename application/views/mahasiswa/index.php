              ...
              <div class="timeline timeline-5 mt-3">
                ...
                <div class="timeline-item align-items-start">
                  ...
                  <div class="timeline-content d-flex">
                    <span class="mr-4 font-weight-bolder text-dark-75">Ujian Proposal</span>
                ...
                <div class="timeline-item align-items-start">
                  ...
                  <!--begin::Content-->
                  <div class="timeline-content d-flex">
                    <span class="mr-4 font-weight-bolder text-dark-75">Mengerjakan Tugas Akhir</span>
                ...
                <div class="timeline-item align-items-start">
                  ...
                  <!--begin::Content-->
                  <div class="timeline-content d-flex">
                    <span class="mr-4 font-weight-bolder text-dark-75">Sidang Tugas Akhir</span>
                ...
                <div class="timeline-item align-items-start">
                  ...
                  <div class="timeline-content text-dark-50">
                    <div class="card card-custom">
                      <div class="card-header">
                        <h3 class="card-title">
                          Upload Laporan Tugas Akhir, Paper dan Poster
                        </h3>
                      </div>
                      <!--begin::Form-->
                      <form class="form" method="post" action="<?= base_url('mahasiswa/step2') ?>" enctype="multipart/form-data">
