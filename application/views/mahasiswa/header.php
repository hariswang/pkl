                            ...
                            <div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
                                ...
                                <ul class="menu-nav">
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="click" aria-haspopup="true">
                                        <a href="<?= base_url('mahasiswa/index/'); ?>" class="btn btn-light btn-text-primary btn-hover-text-primary font-weight-bold">Progres</a>
                                    </li>
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="click" aria-haspopup="true">
                                        <a href="<?= base_url('mahasiswa/riwayat/'); ?>" class="btn btn-light btn-text-primary btn-hover-text-primary font-weight-bold">Riwayat Laporan</a>
                                    </li>
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="click" aria-haspopup="true">
                                        <a href="<?= base_url('mahasiswa/absensi/'); ?>" class="btn btn-light btn-text-primary btn-hover-text-primary font-weight-bold">Absensi Berita Acara</a>
                                    </li>
                                </ul>
                                <!--end::Header Nav-->
                            </div>
