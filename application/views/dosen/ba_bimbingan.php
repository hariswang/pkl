...
<section class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Berita Acara Bimbingan Mahaiswa</h3>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form" method="post" action="<?= base_url('dosen/tambah_absensi') ?>">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Nama Mahasiswa</label>
                                        <div></div>
                                        <select class="custom-select form-control" name="nim" id="nim">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($mahasiswa as $mhs) : ?>
                                            <tr>
                                                ...
                                                <td><?= $mhs->nama; ?></td>
                                                <td>
                                                    <a href="<?php echo site_url(); ?>dosen/jml_ba_bimbingan/<?= $mhs->nama; ?>" target="_blank" class=" btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Cek</a>
                                                </td>
                                            </tr>
                                            <?php $i++; ?>
                                        <?php endforeach; ?>
