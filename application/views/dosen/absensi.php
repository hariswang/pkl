  ...
  <form class="form" method="post" action="<?= base_url('dosen/cek_mhs') ?>">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Absensi Bimbingan</h3>
      </div>
      <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <?php foreach ($mahasiswa as $mhs) : ?>
                      <tr>
                        ...
                        <td><?= $mhs->judul; ?></td>
                        <td>
                          <a href="<?php echo site_url(); ?>dosen/absensi_bimbingan/absensi<?= $mhs->nim; ?>" target="_blank" class=" btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">absensi</a>
                        </td>
                      </tr>
                      <?php $i++; ?>
                    <?php endforeach; ?>
