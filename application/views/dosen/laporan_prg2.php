...
<section class="content">
    <form class="form" method="post" action="<?= base_url('dosen/tanggapan2/') ?>">
        <!-- Default box -->
        <div class="card">
                        ...
                        <div class="card card-custom gutter-b">
                            <div class="table-responsive">
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($mahasiswa as $mhs) : ?>
                                                <tr>
                                                    ...
                                                    <td><?= $mhs->waktu; ?></td>
                                                    <td>
                                                        <form class="form" method="post" action="<?php echo base_url(); ?>dosen/tanggapan2">
                                    ...
                                    <!--end: Datatable-->
                                    <a href="<?php echo site_url(); ?>dosen/acc_prop2/<?= $mhs->nim; ?>" value="<?php echo $mhs->nim; ?>" class=" btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Acc Proposal</a>
                                </div>
                            </div>
                        </div>
                        <!--end::Card-->
