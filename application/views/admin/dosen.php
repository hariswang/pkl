                            ...
                            <section class="content">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="form" method="post" action="<?= base_url('admin/tambah_dosen') ?>">
                                                            <div class="card-body">
                                        ...
                                        <button type="button" class="btn btn-danger float-right" data-toggle="modal" data-target="#modal">
                                            Set Koordinator TA
                                        </button>
                                        ...
                                        <div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Set Koordinator TA</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form class="form" method="post" action="<?= base_url('admin/set_koordinator') ?>">
                                                            <div class="card-body">
                                                                <div class="form-group">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <?php foreach ($dosen as $dsn) : ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a href="<?php echo site_url(); ?>/admin/hapus_dosen/<?= $dsn->no_induk; ?>" class=" btn btn-sm btn-light-danger font-weight-bolder py-2 px-5">Hapus</a>
                                                                            </td>
                                                                        </tr>
                                                                        <?php $i++; ?>
                                                                    <?php endforeach; ?>
